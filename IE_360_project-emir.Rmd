...
### Data Imputing
Then, to fulfill ‘-1’ parts spline interpolation was used because it provides more unbiased and smoother estimates.
```{r,  warning=FALSE , message=FALSE}
for(i in 1:8){
